...
<!--due: when-absent docs/restructure-2026-07.md | the restructure plan has self-deleted: move this file's superseded sections into a dated snapshot under snapshots/ (do not delete them — they are cited by heading), then update the header warning that routes around them-->
